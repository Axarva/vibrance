...
static const char *colors[][3]      = {
	...
	[SchemeStatus]  = { "#905438", col_white,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
        [SchemeTagsSel]  = { "#ff4747", col_white,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
        [SchemeTagsNorm]  = { "#ffb0b0", col_white,  "#000000"  }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { "#94d3f7", "#000000",  "#000000"  }, // infobar middle  selected {text,background,not used but cannot be empty}
        [SchemeInfoNorm]  = { "#94d3f7", "#000000",  "#000000"  }, // infobar middle  unselected {text,background,not used but cannot be empty}
